    ...
    <section className="relative overflow-hidden bg-surface py-16 sm:py-32">
      ...
      <div className="container-max relative z-10 px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] border border-white/5 bg-surface-container/20 p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] backdrop-blur-2xl sm:p-16 lg:p-20"
        >
