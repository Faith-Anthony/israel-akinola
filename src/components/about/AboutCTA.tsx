            ...
            >
              <Link to="/contact">
                <motion.span
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 rounded-full bg-on-surface px-10 py-5 text-[11px] font-bold tracking-[0.25em] text-surface transition-all hover:bg-primary-container hover:shadow-xl shadow-lg"
                >
                  Work with me
