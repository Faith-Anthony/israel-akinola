...
import backgroundImage from '../../assets/images/hero_contact.webp'
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-6xl lg:text-8xl font-serif font-bold text-on-surface leading-tight"
            >
